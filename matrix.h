    ...
    Les matrices peuvent gerer des bases différentes, allant la manipulation bit à bit à des matrices simple d'uint16_t, il faut cependant bien définir la base
    **/
    struct Matrix
    {
